            ...
            <div class="content-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="{{ route('reality-news.create') }}" class="btn btn-success btn-min-width mb-1">Add News</a>
                    </div>
                </div>
                <div class="card-content collapse show">
                    <div class="card">
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <form id="checkbox-form" action="{{ route('reality-news.bulkDelete') }}" method="POST">
                                    @csrf
                                    <div class="table-responsive">

                                        <table class="table table-bordered realityNewsTable" width="100%">
                                            <thead>
                                                <tr>
...
@push('js')
    <script type="text/javascript">
        $(function() {
            var table = $('.realityNewsTable').DataTable({
                processing: true,
                /*serverSide: true,*/
                order: [1],
                paginate: true,
                ajax: "{{ route('reality-news.index') }}",
                columns: [{
                        data: 'checkbox',
                        name: 'checkbox',
                        orderable: false,
